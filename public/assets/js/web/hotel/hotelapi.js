...
function initializeExternalInterfaces() {
    ...
    function() {
        ...
        function e(n) {
            flashEvent.openlink(n)
        }

        function a(n) {
            n.indexOf("r-hh") >= 0 ? flashEvent.openroom(n) : e("navigator/goto/" + n)
        }
...
function writeMessageBrut(message) {
    flashEvent.openlink("navigator/goto/" + b64EncodeUnicode(message));
}
